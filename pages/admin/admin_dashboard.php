...
<head>
    ...
    <style>
        ...
        .btn-danger:disabled {
            background: linear-gradient(135deg, #ffb8b8, #ffa5a5);
            cursor: not-allowed;
            transform: none;
            box-shadow: none;
        }
            ...
            <div id="rejectionModal" class="modal">
                <div class="modal-content rejection-modal">
                    <div class="modal-header">
                        ...
                        <p class="modal-subtitle">Please review the details carefully</p>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="confirmation-box">
                            <label class="checkbox-container">
                                ...
                                <span class="checkbox-text">I confirm that I want to reject this registration</span>
                            </label>
                        </div>
                    </div>
                    
                    <div class="modal-footer">
                        <button class="btn btn-outline" onclick="closeRejectionModal()">Cancel</button>
                        <button class="btn btn-danger" id="rejectBtn" onclick="handleRejection()">
                            <i class="fas fa-times"></i> Reject
                        </button>
                    </div>
                </div>
