        ...
        function selectRecipient(recipientId, recipientName) {
            if (confirm('Are you sure you want to select this recipient?')) {
                ...
                const recipientInfo = {
                    ...
                    organ: row.querySelector('.organ-badge').textContent.trim(),
                    urgency: row.querySelector('.urgency-badge').textContent.trim(),
                    from_hospital: row.querySelector('.hospital-name').textContent.trim()
                };
