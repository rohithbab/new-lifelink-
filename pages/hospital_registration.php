                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; gap: 10px;">
                                <select name="countryCode" style="width: 100px;" required>
                                ...
                                <input type="tel" name="hospital_phone" style="flex: 1;" required placeholder="Enter phone number without country code">
                            </div>
                        </div>
                    </div>
